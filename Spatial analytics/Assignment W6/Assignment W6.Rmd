---
title: "Assignment 6 - Spatial Segregation: Preston Crime continued"
author: "Mie Arnau Martinez"
date: "11/03/2021 updated `r format(Sys.time(), '%B %d, %Y')`"
...
```{r bandwidth-exercise, echo=TRUE, message=FALSE, warning=FALSE}
...
plotcv(bw_choice); abline(v = bw_choice$h, lty = 2, col = "red")
...
```{r optimum-bandwith, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r segregation, echo=TRUE, message=FALSE, warning=FALSE}
